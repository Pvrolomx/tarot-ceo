  ...
  return (
    <div className="card-container w-32 h-48 md:w-40 md:h-60 cursor-pointer" onClick={onClick}>
      <div className={`card-flip w-full h-full ${isFlipped ? 'flipped' : ''}`}>
        {/* Back of card */}
        <div className="card-front w-full h-full rounded-xl overflow-hidden glow relative">
          <Image src={CARD_BACK} alt="Card back" fill className="object-cover" />
        </div>
        {/* Front of card */}
        <div className={`card-back w-full h-full rounded-xl overflow-hidden relative ${isReversed ? 'rotate-180' : ''}`}>
          {card && (
